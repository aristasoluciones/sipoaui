...
const CatalogoManager: React.FC<CatalogoManagerProps> = ({
  config,
  data,
  onSave,
  onDelete,
      ...
      switch (column.type) {
        ...
        case 'textarea':
          ...
          if (column.field === 'nombre') {
            fieldSchema = fieldSchema.min(2, 'El nombre debe tener al menos 2 caracteres')
        ...
        return (
          <>
            <Dropdown
              ...
              placeholder={`Seleccionar ${column.header.toLowerCase()}`}
        ...
        return (
          <>
            <InputText
              ...
              placeholder={`Ingrese ${column.header.toLowerCase()}`}
              className={fieldClass}
            />
            {hasError && <small className="p-error block mt-1">{error}</small>}
          </>
            ...
            header={
              <div>
                <span className="text-xl font-semibold">
                  {editingItem?.id ? 'Editar Registro' : 'Nuevo Registro'}
                </span>
                  ...
                  return (
                    <div key={column.field} className={colClass}>
                      ...
                      {renderFormField(
                        ...
                        (value) => setEditingItem({ ...editingItem, [column.field]: value }),
